...
function init(){
	...
	chrome.storage.sync.get(["firstDate", "optionskipremember", "txtvalue", "counter", "copy", "speech", "voices", "fontsize", "lineheight", "colorlight", "colordark", "backgroundlight", "backgrounddark", "backgroundcolor", "backgroundimage", "backgroundsource", "backgroundsize", "print", "password", "enterpassword"], function(items){
		...
		if(firstmonth){
			// show nothing
			document.getElementById("exabeampromo").className = "hidden";
		}else{
			if(items["optionskipremember"] != true){
				document.getElementById("exabeampromo").className = ""; // show now always the banner
			}else{
				document.getElementById("exabeampromo").className = "hidden";
			}
		}
...
function showcopytextbadge(){
	...
	div.setAttribute("id", "exabeamremoteadd");
	div.className = "exabeamremote";
	...
	window.setTimeout(function(){
		var element = document.getElementById("exabeamremoteadd");
